...
public class PsMicroApp {

    private static final Logger log = LoggerFactory.getLogger(PsMicroApp.class);

    private final Environment env;

    public PsMicroApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PsMicroApp.class);
